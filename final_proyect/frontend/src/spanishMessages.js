export const spanishMessages = {
    ra: {
        ...
        message: {
            ...
            bulk_delete_content: '¿Seguro que deseas eliminar este %{name}? |||| ¿Seguro que deseas eliminar estos %{smart_count} elementos?',
            bulk_delete_title: 'Eliminar %{name} |||| Eliminar %{smart_count} %{name}',
            bulk_update_content: '¿Seguro que deseas actualizar este %{name}? |||| ¿Seguro que deseas actualizar estos %{smart_count} elementos?',
            bulk_update_title: 'Actualizar %{name} |||| Actualizar %{smart_count} %{name}',
            clear_array_input: '¿Seguro que deseas borrar la lista completa?',
            ...
            loading: 'La página se está cargando, por favor espera un momento.',
            no: 'No',
            not_found: 'O has escrito una URL incorrecta o has seguido un enlace incorrecto.',
            yes: 'Sí',
            unsaved_changes: 'Algunos de tus cambios no se guardaron. ¿Estás seguro de que quieres ignorarlos?',
        },
        navigation: {
            no_results: 'No se encontraron resultados',
            no_more_results: 'La página %{page} está fuera de límites. Intente la página anterior.',
            page_out_of_boundaries: 'Página %{page} fuera de límites',
            page_out_from_end: 'No se puede avanzar después de la última página',
        ...
        notification: {
            ...
            data_provider_error: 'Error del proveedor de datos. Consulta la consola para obtener más detalles.',
        ...
        configurable: {
            ...
            inspector: {
                title: 'Inspector',
                content: 'Pasa el cursor por los elementos de la interfaz de la aplicación para configurarlos',
